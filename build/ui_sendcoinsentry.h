...
public:
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        addAsLabel->setToolTip(QApplication::translate("SendCoinsEntry", "<html><head/><body><p>Enter a label for this address to add it to your address book</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
