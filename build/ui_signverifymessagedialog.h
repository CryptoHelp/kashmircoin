...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->setStyleSheet(QString::fromUtf8("background-color:rgb(239,222,212)"));
        ...
        addressIn_SM->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        horizontalLayout_1_SM->addItem(verticalSpacer_2);
        ...
        horizontalLayout_1_SM->addItem(verticalSpacer_3);
        ...
        messageIn_SM->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        signatureOut_SM->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        horizontalLayout_2_SM->addItem(verticalSpacer_4);
        ...
        addressIn_VM->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        horizontalLayout_1_VM->addItem(verticalSpacer);
        ...
        messageIn_VM->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        signatureIn_VM->setStyleSheet(QString::fromUtf8("background-color:white"));
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this Kashmircoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified Kashmircoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
