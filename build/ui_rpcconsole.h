...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QString::fromUtf8("background-color:rgb(239,222,212)"));
        ...
        messagesWidget->setStyleSheet(QString::fromUtf8("background-color:white\n"
""));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Kashmircoin - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "Kashmircoin Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Kashmircoin debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Kashmircoin-Qt help message to get a list with possible Kashmircoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
