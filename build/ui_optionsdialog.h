...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->resize(629, 380);
        OptionsDialog->setStyleSheet(QString::fromUtf8("background-color:rgb(239,222,212)"));
        ...
        transactionFee->setBaseSize(QSize(100, 21));
        transactionFee->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        reserveBalance->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        transactionFeeInfoLabel->raise();
        reserveBalanceInfoLabel->raise();
        bitcoinAtStartup->raise();
        detachDatabases->raise();
        ...
        proxyIp->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        proxyPort->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        socksVersion->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        lang->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        unit->setStyleSheet(QString::fromUtf8("background-color:white"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Kashmircoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Kashmircoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Kashmircoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Kashmircoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Kashmircoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Kashmircoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
