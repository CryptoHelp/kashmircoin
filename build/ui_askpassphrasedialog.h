...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->setStyleSheet(QString::fromUtf8("background-color:rgb(239,222,212)"));
        ...
        passEdit1->setPalette(palette);
        passEdit1->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        passEdit2->setPalette(palette1);
        passEdit2->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        passEdit3->setStyleSheet(QString::fromUtf8("background-color:white"));
