...
public:
    ...
    void setupUi(QDialog *EditAddressDialog)
    {
        ...
        EditAddressDialog->setStyleSheet(QString::fromUtf8("background-color:rgb(239,222,212)"));
        ...
        labelEdit->setStyleSheet(QString::fromUtf8("background-color:white"));
        ...
        addressEdit->setStyleSheet(QString::fromUtf8("background-color:white"));
